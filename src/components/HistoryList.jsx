import { getHistory, deleteHistoryItem, clearHistory } from '../utils/history.js'
import { useState } from 'react'

export default function HistoryList({ onView, onClose }) {
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex gap-2 shrink-0">
                <button
                  ...
                  className="bg-primary text-white text-sm px-4 py-2 rounded-lg hover:bg-primary-dark transition opacity-0 group-hover:opacity-100 md:opacity-100"
                >
                  查看
                </button>
                <button
